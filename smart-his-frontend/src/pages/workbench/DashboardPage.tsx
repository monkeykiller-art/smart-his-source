...
const serviceNames: Record<string, string> = { auth: '统一认证', patient: '患者服务', clinical: '临床服务', resource: '资源保障', operations: '运营管理', collaboration: '协同服务', pharma: '药事服务', cdss: '临床决策', drg: 'DRG 管理', emergency: '急诊服务', platform: '平台服务' }
  ...
  return (
    <>
      ...
      <section className="metric-grid">
        <Card size="small" className="metric-card"><div className="metric-label">在线服务</div><div className="metric-value">{online}<small> / {services.length}</small></div><div className="metric-note">每 30 秒自动检测</div></Card>
        ...
        <Card size="small" className="metric-card"><div className="metric-label">异常服务</div><div className="metric-value metric-value-warning">{services.length - online}<small> 项</small></div><div className="metric-note">请检查未连接服务</div></Card>
